...
public class MyCatInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if( dataNode != null ) {        
	        StringBuilder mycatcomment = new StringBuilder("/*mycat:datanode=").append(dataNode).append("*/").append(originalSql);
	        
	        //FieldUtils.writeField(boundSql, SQL, mycatcomment.toString(), true);
        }
